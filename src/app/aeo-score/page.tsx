        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Comprehensive AI Engine Optimization analytics to measure your
              business visibility across AI platforms. Get detailed scoring,
              performance insights, and actionable optimization recommendations.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-gray-50 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              Start Your AEO Analytics Report
            </h2>
            ...
            <div className="mb-6">
              ...
              <div className="mt-2 text-sm text-gray-500">
                <strong>Examples:</strong> AEO, Answers Engine Optimization,
                digital marketing, restaurant delivery, software development,
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                disabled={
                  !businessName.trim() || !keyword.trim() || isAnalyzing
                }
        ...
        <div className="bg-gray-50 py-12">
          <div className="max-w-6xl mx-auto px-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">
              Testing Against {aiProviders.length} Major AI Engine
              {aiProviders.length !== 1 ? 's' : ''} with Smart Keyword Queries
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
              {aiProviders.map((provider, index) => (
                ...
                >
                  <span
                    className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${provider.color}`}
                  >
                    {provider.name}
                  </span>
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-gray-600 max-w-3xl mx-auto">
                Each AI engine will be asked to list companies based on your
                keyword: <strong>{keyword.trim()}</strong>. We&apos;ll check if{' '}
                <strong>{businessName}</strong> appears in these AI-generated
                company lists to measure organic visibility.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg p-8 mb-8">
              <div className="text-center">
                <h3 className="text-2xl font-bold mb-6">
                  Overall AEO Rankings for {businessName}
                </h3>
                    ...
                    <div className="relative w-48 h-48">
                      ...
                      >
                        ...
                        <circle
                          ...
                          fill="none"
                          strokeDasharray={`${
                            (results.reduce((sum, r) => sum + r.aeoScore, 0) /
                              results.length /
                              100) *
                            440
                          } 440`}
                  ...
                  {results.map((result, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-4">
                        <span
                          className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${result.provider.color}`}
                        >
                      ...
                      <div className="text-sm text-gray-600">
                        Found in{' '}
                        {
                          result.queryVariations.filter((q) => q.mentioned)
                            .length
                        }{' '}
                        AI-generated company lists
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-8 text-sm text-gray-600">
                  <p>
                    Rankings based on comprehensive analysis across major AI
                    engines.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-8">
              {results.map((result, index) => (
                <div key={index} className="bg-gray-50 rounded-lg p-8">
                      ...
                      <div>
                        <div
                          className={`text-2xl font-bold ${
                            result.overallVisibility >= 50
                              ? 'text-green-600'
                              : result.overallVisibility >= 25
                              ? 'text-yellow-600'
                              : 'text-red-600'
                          }`}
                        >
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              {query.mentioned && (
                                <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">
                                  Found • Rank {query.rankPosition} • Score{' '}
                  ...
                  {/* Missed Responses */}
                  {result.missedResponses &&
                    result.missedResponses.length > 0 && (
                      <div className="mb-6">
                        <h4 className="font-semibold mb-4">
                          Responses Without Your Business:
                        </h4>
                        <div className="space-y-3">
                          {result.missedResponses
                            .slice(0, 3)
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
              <span className="text-gray-600">
                One-click AEO & SEO optimization
              </span>
              <span className="text-gray-600">
                &copy; {new Date().getFullYear()} SearchDogAI
              </span>
            </div>
          </div>
        </div>
