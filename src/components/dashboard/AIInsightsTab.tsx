            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-start space-x-3">
                  <div className="text-2xl">{getCriticalityIcon(insight.criticality)}</div>
                  <div className="flex-1">
                    ...
                    {insight.metrics && (
                      <div className="flex space-x-4 mb-3 text-sm">
                        {insight.metrics.currentScore !== undefined && (
                          <div className="text-gray-400">
                            Current Score: <span className="text-white font-medium">{insight.metrics.currentScore}/100</span>
                          </div>
                        )}
                        {insight.metrics.potentialImprovement !== undefined && (
                          <div className="text-gray-400">
                            Potential: <span className="text-green-400 font-medium">+{insight.metrics.potentialImprovement} points</span>
                          </div>
                        )}
                        {insight.metrics.affectedQueries !== undefined && (
                          <div className="text-gray-400">
                            Affected Queries: <span className="text-white font-medium">{insight.metrics.affectedQueries}</span>
                          </div>
                        )}
                      </div>
                    )}
